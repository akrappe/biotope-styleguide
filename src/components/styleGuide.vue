<template>
  <div class="styleGuide">
    ...
    <ul class="styleGuide__items">
      <li v-for="jsonch in myjson" class="styleGuide__item">
        <a :href="jsonch.biotope.url">{{ jsonch.biotope.componentName }}</a>
        <p><span class="styleGuide__meta">Description:</span>{{ jsonch.biotope.description }}</p>
        <p><span class="styleGuide__meta">Category:</span>{{ jsonch.biotope.category }}</span></p>
        <p><span class="styleGuide__meta">Component Variants:</span><span v-for="variant in jsonch.biotope.componentVariants">{{ variant }} </span></p>
        <p><span class="styleGuide__meta">Type:</span>{{ jsonch.biotope.type}}</p>
      </li>
    </ul>
  </div>
</template>
